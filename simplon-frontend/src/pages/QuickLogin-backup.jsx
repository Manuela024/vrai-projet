...
// // src/pages/QuickLogin.jsx - VERSION COMPLÃˆTE ET CORRIGÃ‰E
...
//       console.log('âœ… Utilisateur crÃ©Ã© et stockÃ©:', user);
//       console.log('ðŸ”‘ Token stockÃ©:', localStorage.getItem('access_token'));
      
//       // VÃ©rifier que c'est bien stockÃ©
//       const storedUser = localStorage.getItem('user');
//       const storedToken = localStorage.getItem('access_token');
      
//       if (!storedUser || !storedToken) {
//         throw new Error('Erreur lors du stockage des donnÃ©es');
//       }
      
//       // VÃ©rification via authService
//       console.log('ðŸ” VÃ©rification authService:');
...
//     console.log('ðŸ‘‘ Admin direct crÃ©Ã©');
//     window.location.href = '/admin';
//   };
...
//     console.log('ðŸ‘¤ Utilisateur direct crÃ©Ã©');
//     window.location.href = '/dashboard';
//   };
...
//       } catch (e) {
//         alert('Erreur de lecture des donnÃ©es');
//       }
//     } else {
...
//           <p className="text-sm opacity-90 mt-1">Mode DÃ©veloppement - Connexion directe</p>
//         </div>
...
//                 Utilisez "admin" pour accÃ©der au dashboard admin
//               </p>
//             </div>
...
//               />
//               <p className="text-xs text-gray-500 mt-1">
//                 En mode dÃ©veloppement, n'importe quel mot de passe fonctionne
//               </p>
//             </div>
//           </div>
...
//               âš¡ Connexions directes (sans formulaire) :
//             </p>
...
//               <li>â€¢ <strong>Admin</strong> : Utilisez "admin" comme matricule</li>
//               <li>â€¢ <strong>Utilisateur</strong> : Utilisez "user123" ou autre</li>
//               <li>â€¢ <strong>Redirection</strong> : Automatique selon le rÃ´le</li>
//               <li>â€¢ <strong>Mode dÃ©veloppement</strong> : Pas besoin de backend</li>
//               <li>â€¢ <strong>ProblÃ¨me ?</strong> Utilisez "Connexions directes"</li>
//             </ul>
//           </div>
//         </form>
//       </div>
...
//     try {
//       console.log('ðŸ” DÃ©but processus authentification...');
      
//       let result;
      
//       if (mode === 'api') {
//         // Force l'API Django (vÃ©rification rÃ©elle)
//         console.log('ðŸ” Mode API Django activÃ©');
...
//         console.log('âš¡ Mode auto: essaie API puis simulation');
...
//         console.log('ðŸ‘‘ RÃ´le:', isAdmin ? 'ADMIN' : 'UTILISATEUR');
...
//     } catch (err) {
//       console.error('âŒ Ã‰chec authentification:', err);
//       setError(err.message || 'Erreur de connexion');
//     } finally {
//       setLoading(false);
//     }
...
//   // Tester la connexion API rÃ©elle
//   const testApiConnection = async () => {
//     try {
//       setLoading(true);
//       // Tester avec des identifiants bidons pour voir si l'API rÃ©pond
//       await authService.login('test', 'test');
//     } catch (error) {
//       if (error.message.includes('non accessible')) {
//         alert('âŒ Serveur Django non accessible sur localhost:8000\n\nUtilisez le mode simulation.');
//       } else if (error.message.includes('incorrect')) {
//         alert('âœ… API Django fonctionne mais identifiants incorrects\n\nC\'est normal, l\'API rÃ©pond correctement.');
//       } else {
//         alert(`âš ï¸ ${error.message}\n\nUtilisez le mode simulation pour le dÃ©veloppement.`);
//       }
//     } finally {
//       setLoading(false);
//     }
...
//           </div>
//           <h1 className="text-2xl font-bold">Connexion Simplon</h1>
//           <p className="text-sm opacity-90 mt-1">VÃ©rification dans la base de donnÃ©es</p>
//         </div>
...
//                 { value: 'api', label: 'API Django', desc: 'VÃ©rification rÃ©elle BD' },
//                 { value: 'mock', label: 'Simulation', desc: 'Pour dÃ©veloppement' }
//               ].map((option) => (
//                 <button
//                   key={option.value}
//                   type="button"
...
//           <div className="pt-4 border-t border-gray-200">
//             <p className="text-sm font-medium text-gray-700 mb-3">
//               ðŸ”§ Identifiants de test (simulation) :
//             </p>
...
//                 className="w-full py-2 px-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm transition-colors"
//               >
//                 ðŸ” Tester connexion API Django
//               </button>
              
//               <p className="text-xs text-gray-500 text-center">
//                 Les identifiants invalides seront rejetÃ©s
//               </p>
//             </div>
//           </div>
...
//           <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
//             <h4 className="text-sm font-semibold text-blue-800 mb-2">
//               â„¹ï¸ Processus d'authentification :
//             </h4>
//             <ol className="text-xs text-blue-700 space-y-1 list-decimal pl-4">
//               <li>Saisie matricule/mot de passe</li>
//               <li>VÃ©rification dans la base de donnÃ©es</li>
//               <li>Si valide â†’ vÃ©rification rÃ´le (admin/user)</li>
//               <li>Redirection vers le bon dashboard</li>
//               <li>Si invalide â†’ message d'erreur</li>
//             </ol>
//           </div>
//         </form>
//       </div>
...
// // src/pages/QuickLogin.jsx - VERSION COMPLÃˆTE CORRIGÃ‰E
// import React, { useState } from 'react';
...
//     try {
//       console.log('ðŸ” DÃ©but processus authentification...');
//       console.log('ðŸ“ Identifiants:', { matricule, password, mode });
...
//       console.log('âœ… RÃ©sultat authService:', result);
      
//       if (result.success) {
//         const user = result.user;
        
//         // DÃ‰TERMINER SI C'EST UN ADMIN OU UN UTILISATEUR
//         // 1. VÃ©rifier par le rÃ´le spÃ©cifique
//         const isAdmin = user.role === 'admin' || user.isAdmin === true;
        
//         // 2. VÃ©rifier par le matricule (fallback)
//         const isAdminByMatricule = matricule.toLowerCase().includes('admin');
        
//         // 3. VÃ©rifier via authService
//         const authServiceIsAdmin = authService.isAdmin();
        
//         // DÃ©cision finale
//         const finalIsAdmin = isAdmin || isAdminByMatricule || authServiceIsAdmin;
        
//         console.log('ðŸ‘‘ DÃ©tection rÃ´le:');
//         console.log('   - Par rÃ´le user:', isAdmin ? 'ADMIN' : 'USER');
...
//         // DEBUG : VÃ©rifier ce qui est stockÃ©
//         console.log('ðŸ” DEBUG - AprÃ¨s authService:');
...
//         console.log('ðŸ” Token stockÃ©:', storedToken ? 'âœ… OUI' : 'âŒ NON');
//         console.log('ðŸ‘¤ User stockÃ©:', storedUser ? 'âœ… ' + storedUser.substring(0, 100) + '...' : 'âŒ NON');
        
//         // REDIRECTION CORRECTE
//         setTimeout(() => {
//           if (finalIsAdmin) {
//             console.log('ðŸš€ Admin dÃ©tectÃ© - Redirection vers /admin (AdminDashboard.jsx)');
//             navigate('/admin'); // PAGE DASHBOARD ADMIN
//           } else {
//             console.log('ðŸš€ Utilisateur normal - Redirection vers /dashboard (Dashboard.jsx)');
//             navigate('/dashboard'); // DASHBOARD UTILISATEUR
//           }
//         }, 150);
//       } else {
//         throw new Error(result.message || 'Authentification Ã©chouÃ©e');
//       }
...
//     setPassword('admin123');
//     setMode('mock');
//     console.log('ðŸ‘‘ Identifiants admin remplis');
...
//     setPassword('password123');
//     setMode('mock');
//     console.log('ðŸ‘¤ Identifiants user remplis');
...
//         isAdmin: true
//       }));
//       console.log('ðŸ‘‘ Auth admin manuelle configurÃ©e');
//       alert('âœ… Auth ADMIN configurÃ©e!\nRedirigez vers /admin (AdminDashboard.jsx)');
//     } else {
...
//         isAdmin: false
//       }));
//       console.log('ðŸ‘¤ Auth user manuelle configurÃ©e');
//       alert('âœ… Auth USER configurÃ©e!\nRedirigez vers /dashboard (Dashboard.jsx)');
//     }
    
//     // Afficher ce qui est stockÃ©
//     console.log('ðŸ“¦ localStorage aprÃ¨s config manuelle:', Object.keys(localStorage));
//     console.log('ðŸ” Token:', localStorage.getItem('simplon_access_token'));
//     console.log('ðŸ‘¤ User:', localStorage.getItem('simplon_user'));
//   };
...
//       console.log('ðŸ” Test API result:', result);
      
//       if (result.success) {
//         alert('âœ… API Django fonctionne et accepte les identifiants!');
//       } else {
//         alert('âš ï¸ API rÃ©pond mais identifiants incorrects\n\nC\'est normal pour le test.');
//       }
//     } catch (error) {
...
//   // VÃ©rifier l'Ã©tat actuel de l'auth
...
//     console.log('ðŸ” Ã‰tat actuel auth:');
//     console.log('ðŸ“¦ Toutes les clÃ©s:', Object.keys(localStorage));
//     console.log('ðŸ” Token:', token);
//     console.log('ðŸ‘¤ User:', userStr);
    
//     let message = 'Ã‰tat d\'authentification:\n\n';
//     message += `Token: ${token ? 'âœ… PRÃ‰SENT' : 'âŒ ABSENT'}\n`;
    
//     if (userStr) {
//       try {
//         const user = JSON.parse(userStr);
//         message += `Utilisateur: ${user.username || user.email}\n`;
//         message += `RÃ´le: ${user.role || 'non spÃ©cifiÃ©'}\n`;
//         message += `Admin: ${(user.role === 'admin' || user.isAdmin) ? 'âœ… OUI' : 'âŒ NON'}\n`;
//         message += `Redirection: ${(user.role === 'admin' || user.isAdmin) ? '/admin (AdminDashboard)' : '/dashboard (Dashboard)'}`;
//       } catch {
//         message += 'User: âŒ DonnÃ©es invalides';
//       }
//     } else {
//       message += 'User: âŒ ABSENT';
//     }
...
//     console.log(`ðŸ§ª Test redirection directe vers: ${path}`);
...
//     localStorage.clear();
//     console.log('ðŸ§¹ Auth effacÃ©e');
//     alert('DÃ©connexion effectuÃ©e');
//     navigate('/quick-login');
//   };

//   // Navigation vers diffÃ©rentes pages
...
//               >
//                 ðŸ”Ž VÃ©rifier Ã©tat auth actuel
//               </button>
              
//               {/* Redirections directes - CORRIGÃ‰ES */}
...
//           {/* Info processus - CORRIGÃ‰ */}
//           <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
//             <h4 className="text-sm font-semibold text-blue-800 mb-2">
//               â„¹ï¸ Redirections configurÃ©es :
//             </h4>
//             <ul className="text-xs text-blue-700 space-y-1 list-disc pl-4">
//               <li><strong>Admin</strong> â†’ <code>/admin</code> <span className="font-bold">(AdminDashboard.jsx)</span></li>
//               <li><strong>Utilisateur</strong> â†’ <code>/dashboard</code> <span className="font-bold">(Dashboard.jsx)</span></li>
//               <li><strong>Mode simulation</strong> activÃ© par dÃ©faut</li>
//               <li><strong>Logs dÃ©taillÃ©s</strong> dans la console (F12)</li>
//             </ul>
...
//                 <li><code>/admin</code> â†’ Dashboard Admin</li>
//                 <li><code>/admin/project-management</code> â†’ Gestion projets</li>
//                 <li><code>/admin/user-management</code> â†’ Gestion utilisateurs</li>
//                 <li><code>/dashboard</code> â†’ Dashboard utilisateur</li>
//               </ul>
//             </div>
//           </div>
//         </form>
...
// src/pages/QuickLogin.jsx - VERSION OPTIMISÃ‰E
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import authService from '../services/auth';
...
const QuickLogin = () => {
  ...
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState('');
  const [showDev, setShowDev] = useState(false); // Option developpeur cachÃ©e
  ...
  const detectRole = (identifiant, userData) => {
    // PrioritÃ© 1: RÃ´le dÃ©fini dans userData
    if (userData?.role === 'admin' || userData?.isAdmin) return 'admin';
    
    // PrioritÃ© 2: Pattern dans l'identifiant
    ...
    // PrioritÃ© 3: Format numÃ©rique pour apprenants
    if (/^\d{5,8}$/.test(identifiant)) return 'user';
    
    // Par dÃ©faut: utilisateur standard
    return 'user';
  };

  // Connexion optimisÃ©e
  const handleLogin = async (e) => {
    ...
    try {
      // Mode ultra-rapide: cache les donnÃ©es pour rÃ©utilisation
      ...
      if (result.success) {
        // DÃ©tection du rÃ´le en temps rÃ©el
        const role = detectRole(identifiant, result.user);
        const redirectPath = role === 'admin' ? '/admin' : '/dashboard';
        
        console.log(`âœ… Login rÃ©ussi - Redirection: ${redirectPath}`);
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">AccÃ¨s rapide aux dashboards</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="p-6">
            ...
            {showDev && (
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-xs text-gray-500 mb-3">ðŸ”§ Mode dÃ©veloppement</p>
                ...
                <p className="mt-3 text-xs text-gray-400">
                  Raccourcis: ALT+A (Admin) â€¢ ALT+U (User) â€¢ CTRL+D (Dev)
                </p>
              </div>
            )}
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-500">
                Appuyez sur <span className="font-mono">CTRL+D</span> pour le mode dÃ©veloppeur
              </p>
            </div>
          </form>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400">
            Â© Simplon â€¢ v2.0 â€¢ {new Date().toLocaleDateString()}
          </p>
