...
// // import authService from '../services/auth'; // â­ CHANGEMENT ICI - import par dÃ©faut
...
// //       newErrors.matricule = 'Le matricule doit contenir au moins 3 caractÃ¨res';
// //     }
...
// //     try {
// //       // ðŸ” APPEL AU BACKEND POUR DEMANDER LE LIEN
// //       const response = await authService.requestLoginLink(formData.matricule, formData.email);
      
// //       if (response.success) {
// //         setSuccessMessage('âœ… Lien de connexion envoyÃ© ! VÃ©rifiez votre email.');
// //       } else {
// //         setErrors({ 
...
// //               Vous recevrez un lien sÃ©curisÃ© par email pour crÃ©er votre mot de passe.
// //             </p>
// //           </form>
// //         </div>
...
// //             Â© 2025 Simplon.co - Plateforme interne
// //           </p>
// //         </div>
// //       </div>
// //     </div>
...
// //     try {
// //       await authService.quickLogin(matricule, password); // â­ UTILISATION DIRECTE
// //       // Redirection selon le rôle
// if (userData?.role === 'admin' || userData?.is_staff || userData?.is_superuser) {
//     navigate('/admin/Admindashboard');
// } else {
//     // Redirection intelligente selon le rôle
// if (result.user && (result.user.role === 'admin' || result.user.is_staff || result.user.is_superuser)) {
//     navigate('/admin/Admindashboard');
// } else {
//     navigate('/dashboard');
// };
...
// import React, { useState } from 'react';
// import { useNavigate } from 'react-router-dom';
// import authService from '../services/auth'; // âœ… Import par dÃ©faut corrigÃ©
