...
// src/pages/Home.jsx - CODE COMPLET AVEC LIENS CORRIGÉS
import React from 'react';
import { Link } from 'react-router-dom';
          ...
          <div className="flex flex-col max-w-6xl flex-1">
            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-800 px-6 sm:px-10 py-4">
              ...
              <nav className="hidden md:flex items-center gap-9">
                ...
                {/* ✅ CORRIGÉ : Activer mon compte → /activation */}
                <Link 
                  className="text-sm font-medium leading-normal transition-colors hover:text-primary" 
                  to="/activation"  // ✅ CHANGÉ DE /login À /activation
                >
                  Activer mon compte
                </Link>
                
                {/* ✅ CORRIGÉ : Connexion → /login */}
                <Link 
                  className="text-sm font-medium leading-normal transition-colors hover:text-primary" 
                  to="/login"  // ✅ CHANGÉ DE /quick-login À /login
                >
                  Connexion
                </Link>
              </nav>
                  ...
                  <div className="flex flex-col gap-6 text-left @[864px]:w-1/2">
                    ...
                    <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      <p className="text-sm text-blue-700 dark:text-blue-300">
                        💡 <strong>Pour les administrateurs :</strong> utilisez votre nom d'utilisateur
                      </p>
                      <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                        💡 <strong>Pour les apprenants :</strong> utilisez votre matricule Simplon
                      </p>
                    </div>
